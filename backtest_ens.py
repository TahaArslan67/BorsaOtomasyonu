"""
ENS (Ethereum Name Service) Backtest
"""
...
def backtest_ens():
    ...
    logger.info(f"ENS backtest: {symbol}")
    ...
    for i in range(len(df) - 4):
        ...
        if i + 4 < len(df):
            ...
            # Basit momentum sinyali
            signal = 1 if df['momentum'].iloc[i] > 0 else -1
