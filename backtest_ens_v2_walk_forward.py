"""
ENS Daha İyi Model Walk-Forward Test
"""
...
def backtest_ens_v2_walk_forward():
    """ENS daha iyi model walk-forward test"""
    symbol = "ENSUSDT"
    
    client = CryptoExchangeClient()
    
    logger.info(f"ENS daha iyi model walk-forward test: {symbol}")
    ...
    logger.info("=" * 60)
    logger.info("ENS DAHA İYİ MODEL WALK-FORWARD TEST")
    logger.info("=" * 60)
    
    # Daha iyi modelleri yükle
    import joblib
    model_4h = joblib.load(f"price_prediction_ENS_4h_v2.pkl")
    model_1d = joblib.load(f"price_prediction_ENS_1d_v2.pkl")
    ...
    logger.info("=" * 60)
    logger.info("4h WALK-FORWARD BACKTEST SONUÇLARI (V2)")
    logger.info("=" * 60)
    ...
    logger.info("=" * 60)
    logger.info("1gün WALK-FORWARD BACKTEST SONUÇLARI (V2)")
    logger.info("=" * 60)
