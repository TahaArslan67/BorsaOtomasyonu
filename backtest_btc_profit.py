...
def backtest_btc_profit():
    """BTC kar odaklı backtest"""
    symbol = "BTCUSDT"
    
    client = CryptoExchangeClient()
    
    logger.info(f"BTC kar odaklı backtest: {symbol}")
    ...
    logger.info("=" * 60)
    logger.info("BTC KAR ODAKLI BACKTEST")
    logger.info("=" * 60)
    ...
    logger.info("=" * 60)
    logger.info("4h BACKTEST SONUÇLARI")
    logger.info("=" * 60)
    ...
    logger.info("=" * 60)
    logger.info("1gün BACKTEST SONUÇLARI")
    logger.info("=" * 60)
