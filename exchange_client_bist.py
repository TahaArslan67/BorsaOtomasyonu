"""
BIST Exchange Client
Borsa İstanbul (Türk hisse senetleri) verisi çeker
"""
...
class BISTExchangeClient:
    ...
    def fetch_ohlcv(self, symbol: str, timeframe: str = "4h", limit: int = 2190):
        ...
        Args:
            symbol: BIST sembolü (örn: THYAO, TUPRS, KCHOL)
        ...
        """
        try:
            # Yahoo Finance BIST symbol format
            ...
            # Veri çek
            if timeframe == "15m" or timeframe == "5m":
