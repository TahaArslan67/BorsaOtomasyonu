...
def backtest_btc_may_2020():
    """BTC 2020 Mayıs backtest"""
    symbol = "BTCUSDT"
    
    client = CryptoExchangeClient()
    
    logger.info(f"BTC 2020 Mayıs backtest: {symbol}")
    
    # Veri çek (2020 Mayıs - yaklaşık 744 bar)
    ...
    logger.info("=" * 60)
    logger.info("BTC 2020 MAYIS BACKTEST")
    logger.info("=" * 60)
    ...
    logger.info("=" * 60)
    logger.info("4h BACKTEST SONUÇLARI (2020 MAYIS)")
    logger.info("=" * 60)
    ...
    logger.info("=" * 60)
    logger.info("1gün BACKTEST SONUÇLARI (2020 MAYIS)")
    logger.info("=" * 60)
