"""
BTC Geliştirilmiş Model Walk-Forward Test
"""
...
def backtest_btc_improved_walk_forward():
    """BTC geliştirilmiş model walk-forward test"""
    symbol = "BTCUSDT"
    
    client = CryptoExchangeClient()
    
    logger.info(f"BTC geliştirilmiş model walk-forward test: {symbol}")
    ...
    logger.info("=" * 60)
    logger.info("BTC GELİŞTİRİLMİŞ MODEL WALK-FORWARD TEST")
    logger.info("=" * 60)
    ...
    logger.info("=" * 60)
    logger.info("4h GELİŞTİRİLMİŞ WALK-FORWARD BACKTEST SONUÇLARI")
    logger.info("=" * 60)
    ...
    logger.info("=" * 60)
    logger.info("1gün GELİŞTİRİLMİŞ WALK-FORWARD BACKTEST SONUÇLARI")
    logger.info("=" * 60)
...
if __name__ == "__main__":
    backtest_btc_improved_walk_forward()
